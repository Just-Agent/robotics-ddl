...
- GitHub Pages: https://just-agent.github.io/robotics-ddl/
- Hub: https://just-agent.github.io/just-ddl/
- Repo: https://github.com/Just-Agent/robotics-ddl
...
- `scripts/crawl-sources.mjs`: source-specific crawler，当前已解析 AI City Challenge 官方 Important Dates；解析失败时保留当前 `data/items.json`。
